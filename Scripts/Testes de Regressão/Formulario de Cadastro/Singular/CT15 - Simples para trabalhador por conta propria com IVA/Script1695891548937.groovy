 ...
 */
'Como Tester quero garantir que o sistema permita efetuar alteração de um Cadastro de Contribuinte Singular Simples'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Singular/criar-cadastro-de-contribuinte-singular-simples-e-alterar-para-trabalhador-por-conta-propria-com-IVA.feature')
