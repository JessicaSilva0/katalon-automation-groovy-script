...
Feature: Cadastro do Contribuinte
  ...
  Scenario: Garantir que o Regime Geral - IVA de CAIXA só fica disponível para Origem Oficiosa
    ...
    Then verificao se regime de caixa esta disponivel para oficioso

 */
'Como Tester quero garantir que o Regime Geral - IVA de CAIXA só fica disponível para Origem Oficiosa'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Singular/criar-cadastro-Trabalhador-Por-Conta-Propria-garantir-se-o-regime-geral-iva-de-caixa-so-fica-disponivel-para-origem-oficiosa.feature')
