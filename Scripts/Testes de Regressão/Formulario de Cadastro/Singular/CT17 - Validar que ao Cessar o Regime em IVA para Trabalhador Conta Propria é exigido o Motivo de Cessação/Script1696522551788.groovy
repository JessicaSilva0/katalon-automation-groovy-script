...
'Como técnico, devo validar que quando é feita a cessação do Regime em IVA, é exigido o Motivo de suspensão'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Singular/validar-que-quando-feita-a-cessação-do-Regime-em-IVA-no-cadastro-Trabalhador-conta-propria-seja-exigido-o-motivo-de-cessacao.feature')
