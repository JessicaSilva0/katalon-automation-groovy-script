 ...
 */
'Como técnico, quero garantir que ao alterar um contribuinte com regime Afectação real, este deverá ter Operações Mistas e um registo de origem Oficiosa'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Singular/alterar-cadastro-Trabalhador-Por-Conta-Propria-Para-Oficiosa-Operacoes-Mistas-Afectacao-Real.feature')
