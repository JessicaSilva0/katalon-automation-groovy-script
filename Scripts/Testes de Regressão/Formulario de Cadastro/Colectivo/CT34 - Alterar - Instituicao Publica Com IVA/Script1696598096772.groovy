 ...
 */
'Como técnico, quero garantir que o sistema permite efetuar alteração de um Cadastro de Contribuinte - Coletivo Instituição Pública com IVA de forma esperada.'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Colectivo/alterar-cadastro-Instituicao-Publica-Com-IVA.feature')
