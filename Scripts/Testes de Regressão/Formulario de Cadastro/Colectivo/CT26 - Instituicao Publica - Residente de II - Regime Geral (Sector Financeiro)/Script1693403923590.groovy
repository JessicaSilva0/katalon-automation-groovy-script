...
'Como técnico, devo ser capaz de cadastar um Contribuinte Colectivo Residente INSTITUIÇÃO PÚBLICA - Regime de II - Regime Geral (Sector Financeiro)'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Colectivo/criar-cadastro-Instituicao-Publica-Regime-II-Regime-Geral-Sector-Financeiro.feature')
