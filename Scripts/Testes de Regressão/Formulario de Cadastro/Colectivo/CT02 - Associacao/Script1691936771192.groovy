 ...
 * Feature: Cadastro do Contribuinte
  ...
  Scenario: Criar NIF Colectivo Associação - Residente
...
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Colectivo/criar-cadastro-Associacao.feature')
