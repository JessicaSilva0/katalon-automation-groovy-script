 ...
 * Feature: Cadastro do Contribuinte
    Como técnico, devo ser capaz de criar um NIF Colectivo Associação Com Direito a Deduções
...
'Como Técnico, quero ser capaz de Criar um NIF Colectivo Associação'
CucumberKW.runFeatureFile('Include/features/Testes de Regressão/Formularios/Cadastro/Colectivo/criar-cadastro-Associacao-IVA-Com-Direito-Deducoes.feature')
